...
console.log("All organic Japanese teas: ",filterTeas(data, { organic: true, origin: "Japan" })); // Returns organic Japanese teas
console.log("Green teas that are in stock : ",filterTeas(data, { type: "green", inStock: true })); // Returns green teas that are in stock